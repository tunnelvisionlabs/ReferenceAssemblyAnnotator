...
namespace TunnelVisionLabs.ReferenceAssemblyAnnotator
{
    ...
    {
        private sealed class MaybeNullAttributeProvidedType : ProvidedAttributeType
        {
            public MaybeNullAttributeProvidedType()
                : base("System.Diagnostics.CodeAnalysis", "MaybeNullAttribute")
            {
            }
